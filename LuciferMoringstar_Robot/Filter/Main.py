# @RoyalKrrishna
from Config import AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, API_KEY, AUTH_GROUPS, TUTORIAL, BUTTON, START_MSG
...
BUTTONS = {}
BOT = {}
SHAREUS_API = 'laaxTOiCZNQzaParnXQIwfP1pGu2'
        ...
        if files:
            for file in files:
                ...
                if not nyva:
                    ...
                    BOT["username"]=nyva
                resp = requests.get(f'https://shareus.in/api?api={SHAREUS_API}&url=https://telegram.dog/{nyva}?start=pr0fess0r_99_-_-_-_{file_id}').json()
