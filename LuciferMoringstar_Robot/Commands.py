    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=message.from_user.id,
                    text="**Join Channel Then Click On Refresh❗️**",
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton("❗Report❗️", url="https://t.me/royalkrrishna")
                    ]
                    ]
        ...
        await message.reply_photo(
            photo='https://telegra.ph/file/8b974d306fd09d10bf70b.jpg',
            caption=START_MSG,
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup(
                [[
...
async def bot_info(bot, message):
    buttons = [
        [
            ...
            InlineKeyboardButton('How To Open Links❓', url=f'{TUTORIAL}')
        ]
        ]
